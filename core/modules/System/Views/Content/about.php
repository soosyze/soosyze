...
<table class="table responsive">
    ...
    <tbody>
        <tr>
            <th>Item 1</th>
            <td data-title="Description">Ante turpis integer aliquet porttitor.</td>
            <td data-title="Price">29.99</td>
        </tr>
        <tr>
            <th>Item 2</th>
            <td data-title="Description">Vis ac commodo adipiscing arcu aliquet.</td>
            <td data-title="Price">19.99</td>
        </tr>
        <tr>
            <th>Item 3</th>
            <td data-title="Description"> Morbi faucibus arcu accumsan lorem.</td>
            <td data-title="Price">29.99</td>
        </tr>
        <tr>
            <th>Item 4</th>
            <td data-title="Description">Vitae integer tempus condimentum.</td>
            <td data-title="Price">19.99</td>
        </tr>
        <tr>
            <th>Item 5</th>
